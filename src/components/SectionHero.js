...
export default class SectionHero extends React.Component {
  render() {
    ...
    return (
      <section id={_.get(section, 'section_id')} className="block hero-block bg-accent outer" style={{ background: `url(${safePrefix(_.get(section, 'image'))})`, backgroundSize: 'cover' }}>
        <div className="inner">
          <div className="grid">
            {/* {_.get(section, 'image') &&
            ...
            <div className="cell block-content" style={{ background: 'linear-gradient(to right, #b5267b, #632695)', marginLeft: '10px' }}>
              {_.get(section, 'title') &&
